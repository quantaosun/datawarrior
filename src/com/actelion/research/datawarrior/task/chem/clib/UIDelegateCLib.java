...
public class UIDelegateCLib implements ActionListener,ChangeListener, GenericEventListener<EditorEvent>,ItemListener,TaskConstantsCLib,TaskUIDelegate {
	...
	private static final String[][] REACTION = {
			...
			{ "Amide formation", "gCh@AGj@vb}ADXhXMjSO?UD gC``@dfZ@pb@!gJY@DDfVhB#Q`P srpH srxI@#!Rm?w~@Hc}hyK| !Rb@K~@Hc}hrjB !RbOvH@oy?bOvc^mp##" },
			...
			{ "Sonogashira", "eM@H~CB` eM@HvCB[UEhXELRlwE?v`!gC`@Diz@`#Qv qH@ qra#!BOwx@_` !B_`AX{P !BOwx@_c}~##" },
			...
			{ "Sulfonamide", "gJPdEaDPHRZe`LXTXN@ gGX@@eRuJAu@vf}AD]hXCg@HAEs`D@c\\C?tsF`!gJXhMD@cIHUhB#sBEl@ sHM@@ sa[KP#!B_l]~q~RM_st !B|Grw_Gy?|Ouw?P !B_`BH_]]}u?p##" },
